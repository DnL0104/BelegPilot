...
namespace TaxReader.Infrastructure.Migrations
{
    ...
    [Migration("20260710133224_AddExtractionSourceAndItemCorrected")]
    partial class AddExtractionSourceAndItemCorrected
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaxReader.Domain.Entities.AuditLogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TaxReader.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("StripeEventId")
                        .IsUnique()
                        .HasDatabaseName("ix_payments_stripe_event_id");
            ...
            modelBuilder.Entity("TaxReader.Domain.Entities.Receipt", b =>
                {
                    ...
                    b.Property<string>("ExtractionSource")
                        ...
                        .HasColumnType("character varying(50)")
                        .HasDefaultValue("Ocr")
                        .HasColumnName("extraction_source");
