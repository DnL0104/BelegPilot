...
```bash
INIT=$(node "D:/Programming/Repos/TaxReader/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Programming/Repos/TaxReader/.claude/get-shit-done/templates/spec.md.
