...
Read and follow `D:/Programming/Repos/TaxReader/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @D:/Programming/Repos/TaxReader/.claude/get-shit-done/workflows/diagnose-issues.md
