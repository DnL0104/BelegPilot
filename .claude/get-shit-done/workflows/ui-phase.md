...
```markdown
Read D:/Programming/Repos/TaxReader/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Programming/Repos/TaxReader/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Programming/Repos/TaxReader/.claude/agents/gsd-ui-checker.md for instructions.
