...
```
Task(
  prompt="Read D:/Programming/Repos/TaxReader/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Programming/Repos/TaxReader/.claude/get-shit-done/templates/SECURITY.md`
