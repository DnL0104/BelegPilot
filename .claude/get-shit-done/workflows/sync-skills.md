...
INSTALL_JS_GLOBAL="D:/Programming/Repos/TaxReader/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Programming/Repos/TaxReader/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
