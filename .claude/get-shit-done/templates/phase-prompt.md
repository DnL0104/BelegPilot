...
<!-- For checkpoint task examples and patterns, see @D:/Programming/Repos/TaxReader/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/Programming/Repos/TaxReader/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Programming/Repos/TaxReader/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Programming/Repos/TaxReader/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
