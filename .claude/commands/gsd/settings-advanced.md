...
<execution_context>
@D:/Programming/Repos/TaxReader/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@D:/Programming/Repos/TaxReader/.claude/get-shit-done/workflows/settings-advanced.md`.
