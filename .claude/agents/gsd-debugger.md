...
<required_reading>
@D:/Programming/Repos/TaxReader/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/Programming/Repos/TaxReader/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Programming/Repos/TaxReader/.claude
                  → checks D:/Programming/Repos/TaxReader/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Programming/Repos/TaxReader/.claude/get-shit-done
                  → writes to D:/Programming/Repos/TaxReader/.claude/get-shit-done/hooks/
...
@D:/Programming/Repos/TaxReader/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Programming/Repos/TaxReader/.claude/get-shit-done/references/common-bug-patterns.md
