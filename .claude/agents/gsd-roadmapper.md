...
Reference full template: `D:/Programming/Repos/TaxReader/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Programming/Repos/TaxReader/.claude/get-shit-done/templates/state.md`.
