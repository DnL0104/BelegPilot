...
<reference>
@D:/Programming/Repos/TaxReader/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Programming/Repos/TaxReader/.claude/get-shit-done/references/user-profiling.md` to load:
