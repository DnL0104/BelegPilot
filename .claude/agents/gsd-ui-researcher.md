...
Use template from `D:/Programming/Repos/TaxReader/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/Programming/Repos/TaxReader/.claude/get-shit-done/templates/UI-SPEC.md`
